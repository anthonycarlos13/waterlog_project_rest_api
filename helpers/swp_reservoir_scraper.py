...
def scrape_timeseries_data(station_id, meta_data):
    swp_client_request_meta_data = requests.get(
        'http://cdec.water.ca.gov/cgi-progs/queryDaily?%s&d=29-May-2016+09:35&span=200days' % station_id)
    request_soupified = BeautifulSoup(swp_client_request_meta_data.text, "html.parser")
...
def ORO(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=75, count_start=50, intervals=25, re_target=1,
...
def CLE(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=138, count_start=92, intervals=23, re_target=1,
...
def LEW(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=57, count_start=38, intervals=19, re_target=1,
                       rs_target=3, o_target=7,
...
def WHI(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=69, count_start=46, intervals=23, re_target=1,
                       rs_target=3, o_target=7,
...
def ANT(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=51, count_start=34, intervals=17, re_target=1,
                       rs_target=3,
...
def SHA(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=87, count_start=58, intervals=29, re_target=1,
                       rs_target=3, o_target=11, i_target=13, pi_target=21,
                       pa_target=23)


def KES(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=33, count_start=22, intervals=11, re_target=1,
...
def ENG(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=39, count_start=26, intervals=13, re_target=1,
...
def UNV(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=21, count_start=14, intervals=7, re_target=1,
                       rs_target=3, o_target=None, i_target=None, pi_target=None,
                       pa_target=None)
...
def INV(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=45, count_start=30, intervals=15, re_target=1,
                       rs_target=3, o_target=9, i_target=11, pi_target=13,
                       pa_target=None)


def BLB(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=69, count_start=46, intervals=23, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=15,
                   pa_target=None)


def NHG(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=69, count_start=46, intervals=23, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=17,
                   pa_target=None)


def CMN(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=45, count_start=30, intervals=15, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=None,
                   pa_target=None)


def PAR(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=39, count_start=26, intervals=13, re_target=1, rs_target=3, o_target=7, i_target=9, pi_target=11,
                   pa_target=None)


def DON(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=21, count_start=14, intervals=7, re_target=1, rs_target=None, o_target=5, i_target=None, pi_target=None,
                   pa_target=None)


def BRD(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=27, count_start=18, intervals=9, re_target=None, rs_target=1, o_target=5, i_target=None, pi_target=7,
                   pa_target=None)


def TUL(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=69, count_start=46, intervals=23, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=None,
                   pa_target=None)


def NML(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=81, count_start=54, intervals=27, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=21,
                   pa_target=None)


def HTH(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=51, count_start=34, intervals=17, re_target=None, rs_target=3, o_target=7, i_target=None, pi_target=11,
                   pa_target=13)
...
def BUC(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=63, count_start=42, intervals=21, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=None,
                   pa_target=None)


def HID(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=75, count_start=50, intervals=25, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=15,
                   pa_target=None)


def MIL(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=75, count_start=50, intervals=25, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=21,
                   pa_target=None)


def SNL(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=21, count_start=14, intervals=7, re_target=1, rs_target=3, o_target=None, i_target=None, pi_target=None,
                   pa_target=None)


def PNF(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=87, count_start=58, intervals=29, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=17,
                   pa_target=None)


def TRM(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=81, count_start=54, intervals=27, re_target=1, rs_target=3, o_target=11, i_target=13, pi_target=17,
                   pa_target=None)
...
def STP(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=33, count_start=22, intervals=11, re_target=1, rs_target=3, o_target=None, i_target=None, pi_target=None,
                   pa_target=None)
...
def PRR(td_list, meta_data):
    return scraper_alg(meta_data=meta_data, td_list=td_list, switch=27, count_start=18, intervals=9, re_target=1, rs_target=3, o_target=None, i_target=None, pi_target=7,
                   pa_target=None)


def scraper_alg(meta_data, td_list, switch, count_start, intervals, re_target, rs_target, o_target, i_target, pi_target,
                pa_target):
    time_series_data = []
    data_fields = {
        "date": None,
