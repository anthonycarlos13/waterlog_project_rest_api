...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('dam_id', models.CharField(max_length=10, null=True)),
                ('name', models.CharField(max_length=100, null=True)),
                ('reservoir_elevation', models.DecimalField(null=True, max_digits=75, decimal_places=2)),
                ('reservoir_storage', models.DecimalField(null=True, max_digits=75, decimal_places=2)),
                ('reservoir_area', models.DecimalField(null=True, max_digits=75, decimal_places=2)),
                ('latitude', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('longitude', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('county', models.CharField(max_length=100, null=True)),
                ('stream', models.CharField(max_length=100, null=True)),
                ('storage_capacity', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('outflow', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('inflow', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('precipitation_incremental', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('precipitation_accumulated', models.DecimalField(null=True, max_digits=75, decimal_places=6)),
                ('date', models.DateTimeField(auto_now=True, null=True)),
                ('source', models.CharField(max_length=500, null=True)),
            ],
        ),
